package audio.paco.playground.robovm;
...
public class PlayNGameRoboVM extends UIApplicationDelegateAdapter {
  ...
  public static void main (String[] args) {
    ...
    UIApplication.main(args, null, PlayNGameRoboVM.class);
    pool.close();
  }
}
